                ...
                component: (function () {
                  function t(t, e, n, o, r) {
                    (this.authService = t),
                      ...
                      (this.loadingBar = o),
                      (this.router = r),
                      (this.imgLogo = "assets/img/logo/seda-logo.png"),
                  ...
                  return (
                    (t.prototype.ngOnInit = function () {
                      this.resetForm = this.formBuilder.group({
                        email: new r.d(
                          "",
                          r.u.compose([r.u.required, r.u.email])
                        ),
                      });
                    }),
                  ...
                  return (
                    (t.prototype.ngOnInit = function () {
                      this.loginForm = this.formBuilder.group({
                        username: new r.d("", r.u.compose([r.u.required])),
                        password: new r.d(
                          "",
                          r.u.compose([r.u.required, r.u.minLength(8)])
                        ),
                      });
                    }),
