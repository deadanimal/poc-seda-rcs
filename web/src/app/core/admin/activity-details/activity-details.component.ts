...
export class ActivityDetailsComponent implements OnInit, OnDestroy {
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivActivityDetails1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivActivityDetails2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivActivityDetails3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivActivityDetails4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivActivityDetails5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivActivityDetails6", am4charts.PieChart);
