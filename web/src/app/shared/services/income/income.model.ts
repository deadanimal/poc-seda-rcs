export class Income {
  ...
  public ay_actual_year: string;
  public ay_actual_generate: string;
  public ay_actual_export: string;
  public ay_prorate: string;
  public ay_date: string;
  ...
  constructor(
    ...
    ay_actual_year: string,
    ay_actual_generate: string,
    ay_actual_export: string,
    ay_prorate: string,
    ay_date: string,
    inf_cre_dt: string,
    inf_cre_usr: string,
    ...
    this.ay_actual_year = ay_actual_year;
    this.ay_actual_generate = ay_actual_generate;
    this.ay_actual_export = ay_actual_export;
