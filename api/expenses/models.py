...
class Expense(models.Model):
    ...
    ay_actual_year = models.CharField(max_length=100, default='NA', blank=True)
    ay_actual_generate = models.CharField(
        max_length=100, default='NA', blank=True)
    ay_actual_export = models.CharField(
        max_length=100, default='NA', blank=True)
    ay_prorate = models.CharField(max_length=100, default='NA', blank=True)
    ay_date = models.CharField(max_length=100, default='NA', blank=True)
